...
public class DataCompletudeStep extends BaseStep implements StepInterface {
   ...
   */
  public DataCompletudeStep( StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis ) {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    // Casting to step-specific implementation classes is safe
	  DataCompletudeStepMeta meta = (DataCompletudeStepMeta) smi;
	  DataCompletudeStepData data = (DataCompletudeStepData) sdi;
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
	    ...
	    if ( first ) {
	      ...
	      data.outputDBpediaIndex = data.outputRowMeta.indexOfValue( meta.getInputDBpedia() );
	      if ( data.outputDBpediaIndex < 0 ) {
	    ...
	    outputRow[data.outputDBpediaIndex] = "Hello World!";
