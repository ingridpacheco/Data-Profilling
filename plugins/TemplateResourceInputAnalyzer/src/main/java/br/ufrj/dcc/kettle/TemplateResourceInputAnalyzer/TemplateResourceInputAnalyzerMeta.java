...
public class TemplateResourceInputAnalyzerMeta extends BaseStepMeta implements StepMetaInterface {
	...
	Trans trans) {
		return new TemplateResourceInputAnalyzerStep(stepMeta, stepDataInterface, cnr, transMeta, trans);
	}
	
	@Override
	public StepDataInterface getStepData() {
		return new TemplateResourceInputAnalyzerData();
	}
