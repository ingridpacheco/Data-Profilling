...
public class ResourceInputAnalyzerDialog extends BaseStepDialog implements StepDialogInterface {
	private ResourceInputAnalyzerMeta TemplateResourceAnalyzer;
	...
	public ResourceInputAnalyzerDialog(Shell parent, Object in, TransMeta tr, String sname) {
		...
		TemplateResourceAnalyzer = (ResourceInputAnalyzerMeta) in;
	...
	public String open() {
		...
		shell.setText("Resource Input Analyzer");// Messages.getString(“KafkaTopicPartitionConsumerDialog.Shell.Title”));
	...
	* @param copyStepname
	*/
	private void getData(ResourceInputAnalyzerMeta TemplateResourceAnalyzer, boolean copyStepname) {
		if (copyStepname) {
	...
	*/
	private void setData(ResourceInputAnalyzerMeta TemplateResourceAnalyzer) {
