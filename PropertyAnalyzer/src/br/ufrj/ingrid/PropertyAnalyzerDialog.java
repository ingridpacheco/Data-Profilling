...
public class PropertyAnalyzerDialog extends BaseStepDialog implements StepDialogInterface {
	...
	private Control buildContents(Control lastControl, ModifyListener defModListener) {
		...
		wGetNotMappedResources = swthlp.appendCheckboxRow(wInputGroup, wProperty, "Consider resources not mapped in template",
	...
	public String open() {
		...
		shell.setText("Property Analyzer");// Messages.getString(“KafkaTopicPartitionConsumerDialog.Shell.Title”));
	...
	* @param copyStepname
	*/
	private void getData(PropertyAnalyzerMeta TemplatePropertyAnalyzer, boolean copyStepname) {
		if (copyStepname) {
	...
	*/
	private void setData(PropertyAnalyzerMeta TemplatePropertyAnalyzer) {
