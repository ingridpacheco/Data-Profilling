...
public class TemplateDataCompletudeDialog extends BaseStepDialog implements StepDialogInterface {
	...
	public String open() {
		...
		props.setLook(shell);
		setShellImage(shell, TemplateDataCompletude);
		...
		changed = TemplateDataCompletude.hasChanged();
		...
		getData(TemplateDataCompletude, true);
	...
	private void ok() {
		...
		setData(TemplateDataCompletude);
		dispose();
	}
	
	private void cancel() {
		stepname = null;
		TemplateDataCompletude.setChanged(changed);
		dispose();
	}
	...
	* @param copyStepname
	*/
	private void getData(TemplateDataCompletudeMeta TemplateDataCompletude, boolean copyStepname) {
		if (copyStepname) {
			wStepname.setText(stepname);
			if (TemplateDataCompletude.getDBpedia() != null)
	...
	*/
	private void setData(TemplateDataCompletudeMeta TemplateDataCompletude) {
