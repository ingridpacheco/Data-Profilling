...
public class TemplateResourceInputAnalyzerDialog extends BaseStepDialog implements StepDialogInterface {
	...
	private Control buildContents(Control lastControl, ModifyListener defModListener) {
		...
		wBrowse = textVarWithButton(wInputGroup, wGetNotMappedResources, "Resources File",
	...
	public String open() {
		...
		shell.setText("Template Resource Input Analyzer");// Messages.getString(“KafkaTopicPartitionConsumerDialog.Shell.Title”));
