...
*
*/
public class TemplateResourceCompletudeDialog extends BaseStepDialog implements StepDialogInterface {
	private TemplateResourceCompletudeMeta TemplateResourceCompletude;
	...
	public TemplateResourceCompletudeDialog(Shell parent, Object in, TransMeta tr, String sname) {
		super(parent, (BaseStepMeta) in, tr, sname);
		TemplateResourceCompletude = (TemplateResourceCompletudeMeta) in;
	...
	public String open() {
		...
		props.setLook(shell);
		setShellImage(shell, TemplateResourceCompletude);
		
		ModifyListener lsMod = new ModifyListener() {
		
			public void modifyText(ModifyEvent e) {
				TemplateResourceCompletude.setChanged();
			}
		};
	
		changed = TemplateResourceCompletude.hasChanged();
		...
		getData(TemplateResourceCompletude, true);
	...
	private void ok() {
		...
		setData(TemplateResourceCompletude);
		dispose();
	}
	
	private void cancel() {
		stepname = null;
		TemplateResourceCompletude.setChanged(changed);
		dispose();
	}
	...
	* @param copyStepname
	*/
	private void getData(TemplateResourceCompletudeMeta TemplateResourceCompletude, boolean copyStepname) {
		if (copyStepname) {
			wStepname.setText(stepname);
			if (TemplateResourceCompletude.getDBpedia() != null)
				wDBpedia.setText(TemplateResourceCompletude.getDBpedia());
			if (TemplateResourceCompletude.getTemplate() != null)
				wTemplate.setText(TemplateResourceCompletude.getTemplate());
			if (TemplateResourceCompletude.getBrowseFilename() != null)
				wBrowse.setText(TemplateResourceCompletude.getBrowseFilename());
			if (TemplateResourceCompletude.getOutputFile() != null)
				wOutputBrowse.setText(TemplateResourceCompletude.getOutputFile());
		}
	}
	...
	*/
	private void setData(TemplateResourceCompletudeMeta TemplateResourceCompletude) {
		stepname = wStepname.getText();
		TemplateResourceCompletude.setDBpedia(wDBpedia.getText());
		TemplateResourceCompletude.setTemplate(wTemplate.getText());
		TemplateResourceCompletude.setBrowseFilename(wBrowse.getText());
		TemplateResourceCompletude.setOutputFile(wOutputBrowse.getText());
		TemplateResourceCompletude.setChanged();
	}
}