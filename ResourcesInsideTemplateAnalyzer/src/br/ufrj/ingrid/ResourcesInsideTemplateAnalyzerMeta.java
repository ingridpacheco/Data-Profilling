...
public class ResourcesInsideTemplateAnalyzerMeta extends BaseStepMeta implements StepMetaInterface {

	private String DBpedia;
	private String template;
	public String browseOutputFilename;
	
	public ResourcesInsideTemplateAnalyzerMeta() {
	...
	Trans trans) {
		return new ResourcesInsideTemplateAnalyzerStep(stepMeta, stepDataInterface, cnr, transMeta, trans);
	}
	
	@Override
	public StepDataInterface getStepData() {
		return new ResourcesInsideTemplateAnalyzerData();
	}
